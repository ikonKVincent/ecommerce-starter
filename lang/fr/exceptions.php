...
return [
    ...
    'not_authorise' => "Vous n'êtes pas authorisé à accèder à cette page.",
    'rate_limiter' => 'Nous sommes désolés, vous avez dépassé le nombre maximum de tentatives. Par mesure de sécurité, veuillez recommencer dans :minutes minute(s) et  :seconds seconde(s).',
];
